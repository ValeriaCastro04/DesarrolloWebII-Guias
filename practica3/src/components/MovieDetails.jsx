...
/**
 * Componente que muestra los detalles de una película y permite al usuario calificarla y agregarla a su lista de vistas. 
 *  @param {Object} props
                    ...
                    <div className="rating">                             
                        {!isWatched ? (                                 
                            <> 
                                ...
                                {userRating > 0 && (
                                    <button className="btn-add" onClick={handleAdd}> + Agregar a la lista
                                    </button>
                                )}
                            </>  
                        ):(
